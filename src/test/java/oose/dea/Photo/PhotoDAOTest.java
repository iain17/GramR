...
public class PhotoDAOTest {
    ...
    public void testSuccessInsert() throws Exception {
        assertEquals(true, photoSQLDAO.insertPhoto(new Photo(500, "Bob", "Mooie foto", "http://google.com/", "geen", null, null)));
    }
    ...
    public void testSuccessInsertMetFilter() throws Exception {
        ...
        assertEquals(true, photoSQLDAO.insertPhoto(new Photo(500, "Bob", "Mooie foto", "http://google.com/", "geen", null, filter)));
    }

    @Test
    public void testFailTooLongInsert() throws Exception {
        assertEquals(false, photoSQLDAO.insertPhoto(new Photo(800, "Bob", "This masterpiece of historical drama presents the voting rights marches in Selma, Alabama in 1965. Though the events happened fifty years ago, this film feels absolutely contemporary. Ava DuVernay directs an enlightening piece at this period in the civil rights movement, drawing out phenomenal acting performances from the talented cast. Test 123", "http://google.com/", "geen", null, null)));
    }
